  ...
  $(document).ready(function () {
    ...
    $(".circle-tag img, .add-fav img, .add-wishlist img").on('click', function () {
      if ($(this).attr("src").toString().indexOf('assets/img/svg/013-heart-1.svg') != -1) {
        this.src = this.src.replace("Content/Assets/img/svg/013-heart-1.svg", "Content/Assets/img/svg/010-heart.svg");
      }
      else {
        this.src = this.src.replace("Content/Assets/img/svg/010-heart.svg", "Content/Assets/img/svg/013-heart-1.svg");
      }
    });
  });
  // Video
