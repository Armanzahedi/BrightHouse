    ...
    b = function () {
        function c(c, d) {
            ...
            if (e.defaults = {
                ...
                arrows: !0,
                asNavFor: null,
                prevArrow: '<button type="button" data-role="none" class="slick-prev font-weight-bold"><i class="fa fa-chevron-left"></i></button>',
                nextArrow: '<button type="button" data-role="none" class="slick-next font-weight-bold "><i class="fa fa-chevron-right"></i></button>',
                autoplay: !1,
                autoplaySpeed: 3e3,
                centerMode: !1,
                centerPadding: "50px",
